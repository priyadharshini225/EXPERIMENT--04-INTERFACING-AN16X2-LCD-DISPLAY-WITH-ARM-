...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "Priyadharshini 96");
...
<img width="792" height="701" alt="Screenshot 2025-10-04 143449" src="https://github.com/user-attachments/assets/1a73f591-8834-411e-a3ea-a0250f26ba3c" />


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
<img width="840" height="756" alt="image" src="https://github.com/user-attachments/assets/8490223c-12a8-4903-9026-37773b6e4fb9" />
